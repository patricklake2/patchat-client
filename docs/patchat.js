var patchat = (function (exports) {
  ...
  */
  ...
  function createClient(siteId) {
    var url = "wss://nugm59x1e1.execute-api.eu-west-2.amazonaws.com/dev?siteId=".concat(siteId);
    return new Promise(function (resolve, reject) {
    ...
    props: {
      sendFunction: {
        ...
        "default": function _default() {
          return function () {
            return console.error('Send function not implemented');
          };
        }
      },
      displayName: {
  ...
  var __vue_render__ = function() {
    ...
    return _c("form", { attrs: { id: "message-input" } }, [
      _vm.replyingTo.threadId !== undefined
        ? _c("label", { attrs: { for: "messagebox" } }, [
            _vm._v(
              "\n    You are replying to " +
                _vm._s(_vm.replyingTo.displayName) +
                ".\n    "
            ),
            _c(
              "button",
              {
                staticClass: "cancelreplybtn",
                attrs: { type: "button", tabindex: "0" },
                on: {
                  click: function($event) {
                    $event.preventDefault();
                    return _vm.$emit("cancelReply")
                  }
                }
              },
              [_vm._v("\n      Cancel\n    ")]
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("label", { staticClass: "hide", attrs: { for: "messagebox" } }, [
        _vm._v("Message:")
      ]),
      _vm._v(" "),
      _c("input", {
  ...
  var script$1 = {
    ...
    computed: {
      threads: function threads() {
        ...
        var threadIds = this.messages.map(function (msg) {
          return msg.threadId;
        });
        var uniqueThreadIds = threadIds.filter(function (id, index, arr) {
          return arr.indexOf(id) === index;
        }); // Create array of threads

        var threads = uniqueThreadIds.map(function (id) {
          var messagesInThread = _this.messages.filter(function (msg) {
            return msg.threadId === id;
          });

          return messagesInThread.sort(function (a, b) {
            return a.timestamp - b.timestamp;
          }); // sort messages within thread
        });
        return threads.sort(function (a, b) {
          return a[0].timestamp - b[0].timestamp;
        }); //sort threads by timestamp on first message
      }
    },
    methods: {
      getLocalTimeString: function getLocalTimeString(utcTimestamp) {
        var date = new Date(0);
        date.setUTCMilliseconds(utcTimestamp);
        var hours = "".concat(date.getHours()).padStart(2, '0');
        var mins = "".concat(date.getMinutes()).padStart(2, '0');
  ...
  var __vue_render__$1 = function() {
    ...
    return _c(
      "ol",
      { attrs: { id: "messages" } },
      _vm._l(_vm.threads, function(thread, idx) {
        return _c(
          "ol",
          { key: idx, staticClass: "thread" },
          _vm._l(thread, function(msg, i) {
            return _c("li", { key: i, class: { message: true, reply: i > 0 } }, [
              _c("span", { staticClass: "name" }, [
                _vm._v(_vm._s(msg.displayName))
              ]),
              _vm._v(" "),
              _c("span", { staticClass: "time" }, [
                _vm._v(_vm._s(_vm.getLocalTimeString(msg.msgTimestamp)))
              ]),
              _vm._v(" "),
              _c("span", { staticClass: "content" }, [
                _vm._v(_vm._s(_vm.decode(msg.content)))
              ]),
              _vm._v(" "),
              _c(
                "button",
  ...
  var script$2 = {
    ...
    props: {
      setNameFunction: {
        ...
        "default": function _default() {
          return function () {
            return console.error('Unimplemented set name function');
          };
        }
      }
    },
  ...
  var __vue_render__$2 = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("form", { attrs: { id: "nameprompt" } }, [
      _c("label", { attrs: { for: "displayname" } }, [
        _vm._v("Welcome to Northernlands 2! Please enter your name below")
      ]),
      _vm._v(" "),
      _c("input", {
        directives: [
        ...
        attrs: { id: "displayname", type: "text" },
      ...
      _c(
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.setNameFunction(_vm.displayName)
            }
          }
        },
        [_vm._v("\n    Enter chat\n  ")]
  ...
  var script$3 = {
    components: {
      Messages: __vue_component__$1,
      MessageInput: __vue_component__,
      NamePrompt: __vue_component__$2
    },
    data: function data() {
      return {
        client: null,
    ...
    methods: {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.prev = 0;
                  _context2.next = 3;
                  return createClient(_this2.$root.siteId);

                case 3:
                  _this2.client = _context2.sent;
                  _this2.connected = true;
                  _this2.messages = [];

                  _this2.requestPreviousMessages();
                ...
                case 13:
                  _this2.client.onmessage = _this2.recieveMessage;

                  _this2.client.onerror = function () {
                    var _ref;

                    return _ref = [true, false], _this2.error = _ref[0], _this2.connected = _ref[1], _ref;
                  };
      ...
      sendData: function sendData(data) {
        this.client.send(JSON.stringify(_objectSpread2({
          siteId: this.$root.siteId
        }, data)));
      },
      requestPreviousMessages: function requestPreviousMessages() {
        this.sendData({
          action: 'getmessages'
        });
      },
      ...
      recieveMessage: function recieveMessage(e) {
        console.log(e);
      ...
      setReplyingTo: function setReplyingTo(msg) {
        this.replyingTo = msg;
      },
      clearReplyingTo: function clearReplyingTo() {
        this.replyingTo = {};
      }
    }
  };
  ...
  var __vue_render__$3 = function() {
    ...
    return _c(
      ...
      [
        _vm.displayName === ""
          ? _c("name-prompt", { attrs: { setNameFunction: _vm.setName } })
          : _vm._e(),
        _vm._v(" "),
        _vm.connected && _vm.displayName
          ? _c("messages", {
              attrs: { messages: _vm.messages },
              on: { reply: _vm.setReplyingTo }
            })
          : _vm._e(),
        _vm._v(" "),
        _vm.displayName
          ? _c("message-input", {
              attrs: {
                sendFunction: _vm.sendMessage,
                displayName: _vm.displayName,
                replyingTo: _vm.replyingTo
              },
              on: { cancelReply: _vm.clearReplyingTo }
            })
          : _vm._e()
      ],
      1
